...
public class BorrowBook extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String readerId = request.getParameter("readerIDToBorrow");
		...
		int ok = LibrarianDao.checkToBorrow(Integer.parseInt(readerId), Integer.parseInt(bookId));
		LibrarianDao.borrowBook(reader, book);
		...
		for(BookBean bean : bookList) {
			...
			for(ReaderBean borrowingReader : borrowedList) {
				out.println("<tr class=\"borrowed-list__item borrowed-item-js\">\r\n"
						+ "                                                <td class=\"borrowed-list__value\">"+borrowingReader.getId()+"</td>\r\n"
						+ "                                                <td class=\"borrowed-list__value\">"+borrowingReader.getBorrowOn()+"</td>\r\n"
						+ "                                            </tr>");
			}
		...
		if(ok == 0) {
			...
			out.println("<div class=\"notice fail active notice-js\">\r\n"
					+ "        <span class=\"notice-content notice-content-js\">\r\n"
					+ "            You have to return the book first!\r\n"
					+ "        </span>\r\n"
					+ "    </div>");
		}
