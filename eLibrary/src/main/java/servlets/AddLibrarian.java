...
public class AddLibrarian extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (!AdminDao.checkExisted(lb)) {
			AdminDao.addLibrarian(lb);
			ok=true;
		}
			
		List<LibrarianBean> libraList = AdminDao.viewLibrarian();
		...
		if(ok) {
			out.println("<div class=\"notice success active notice-js\">\r\n"
					...
					+ "            The librarian was successfully added!\r\n"
					+ "        </span>\r\n"
					+ "    </div>");
		}else {
			out.println("<div class=\"notice fail active notice-js\">\r\n"
					+ "        <span class=\"notice-content notice-content-js\">\r\n"
					+ "            The librarian has existed!\r\n"
					+ "        </span>\r\n"
					+ "    </div>");
		}
